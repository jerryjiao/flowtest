...
- **D4** — plugin install verified in zcode; CI (structure tests + secret scan gate); publish v0.1 — repo, site, and plugin together. ✅ (2026-09-10: real install verified via `claude plugin install` — Skills (2) discovered; zcode consumes the same `.claude-plugin/` manifests; ci.yml + pages.yml; v0.1.0 tagged, repo public, site live)
